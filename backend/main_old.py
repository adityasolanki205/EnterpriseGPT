    ...
    try:
        ...
        if portal == "hr":
            ...
            system_prompt = (
                ...
                "You may answer questions about company policies, leave, and benefits.\n\n"
                "When a question involves a candidate profile or resume, "
                "use ONLY the provided context and return the SAME structured JSON format.\n\n"
                "If resume information is not present in the context, "
                "return empty or 'Not found in documents' fields.\n\n"
                "Context:\n{context}\n\n"
                "IMPORTANT:\n"
                "You must return ONLY valid JSON in the following format.\n"
                "Do not add explanations, markdown, or extra text.\n\n"
